...
- `lib/` - Основной код приложения
  ...
  - `screens/` - Экраны приложения
    ...
    - `home_screen.dart` - Главная страница приложения
    - `settings_screen.dart` -  Окно настройки провайдера и API ключей
    - `stats_screen.dart` - Окно статистики использования токенов
    - `expenses_screen.dart` - График расходов по дням
- `android/`, `ios/`, `windows/`, `linux/` - Платформо-зависимые конфигурации
- `assets/` - Ресурсы приложения
- `pubspec.yaml` - Зависимости проекта (**обязательно добавить fl_chart**)
...
- Использование библиотеки `fl_chart` для построения графиков
